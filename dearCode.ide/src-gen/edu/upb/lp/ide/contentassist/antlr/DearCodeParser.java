...
public class DearCodeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DearCodeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionCallAccess().getGroup_4_1(), "rule__FunctionCall__Group_4_1__0");
			builder.put(grammarAccess.getFunctionCallAccess().getGroup_4_1_1(), "rule__FunctionCall__Group_4_1_1__0");
			...
			builder.put(grammarAccess.getDeclararAccess().getPreComentarioAssignment_3(), "rule__Declarar__PreComentarioAssignment_3");
			builder.put(grammarAccess.getDeclararAccess().getValorAssignment_4(), "rule__Declarar__ValorAssignment_4");
			builder.put(grammarAccess.getDeclararAccess().getPostComentarioAssignment_5(), "rule__Declarar__PostComentarioAssignment_5");
			...
			builder.put(grammarAccess.getFuncionAccess().getTipoAssignment_3_1(), "rule__Funcion__TipoAssignment_3_1");
			builder.put(grammarAccess.getFuncionAccess().getInstruccionesAssignment_5(), "rule__Funcion__InstruccionesAssignment_5");
			...
			builder.put(grammarAccess.getFunctionCallAccess().getComentarioAssignment_3(), "rule__FunctionCall__ComentarioAssignment_3");
			builder.put(grammarAccess.getFunctionCallAccess().getArgsAssignment_4_1_0(), "rule__FunctionCall__ArgsAssignment_4_1_0");
			builder.put(grammarAccess.getFunctionCallAccess().getArgsAssignment_4_1_1_1(), "rule__FunctionCall__ArgsAssignment_4_1_1_1");
